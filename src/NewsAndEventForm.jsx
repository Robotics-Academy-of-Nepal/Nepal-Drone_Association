...
const NewsAndEventForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://api.nepaldroneassociation.org.np/app/news-events/', {
        title,
        content,
        date,
      });
      ...
      for (let i = 0; i < images.length; i++) {
        ...
        await axios.post('https://api.nepaldroneassociation.org.np/app/news-event-images/', imgForm, {
